...
//*FUNCTION-> display available commands*/
void menu(){
...
/**************************************************************************************************/
//*FUNCTION-> assemble function*/

void assemble_f(char * src_file){
	build_optab();	//build opcode table
	pass1(src_file);
  	symtab_to_file();
}
...
//❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤
	...
	if(index == 0){	//load
		if(param1[0] != '\0' && param2[0] == '\0'){
			printf("command has been reached!\n");
		}
		else if(param1[0] == '\0'){
